...
class _CreateCustomerWidgetState extends State<CreateCustomerWidget> {
  ...
  Widget createPrivateUser() {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
        Customwidgets.buildLabel("Land"),
          dropdownCountry(),
        Customwidgets.buildLabel("Navn"),
    Customwidgets.textField(nameController),
          Customwidgets.buildLabel("CVR"),
          Customwidgets. textField(cvrController),
          Customwidgets. buildLabel("Adresse"),
          Customwidgets. buildLabel("Vejnavn"),
          Customwidgets. textField(streetController),
          Customwidgets. buildLabel("Nummer"),
          Customwidgets. textField(numberController),
          Customwidgets. buildLabel("Postnummer"),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          Customwidgets.buildLabel("Land"),
          dropdownCountry(),
          Customwidgets. buildLabel("Firma navn"),
          Customwidgets. textField(nameController),
          Customwidgets. buildLabel("CVR"),
          Customwidgets. textField(cvrController),
          Customwidgets. buildLabel("Adresse"),
